...
// Shared Tailwind classes (or import from a common place)
...
export default function SignupForm({ onSuccess, onSwitchToLogin }: SignupFormProps) {
    ...
    // --- Firestore Profile Create Helper ---
    const createUserProfile = async (user: User) => {
         if (!db) { console.error("Firestore client (db) not available."); return; }
         const userDocRef = doc(db, "users", user.uid);
         // Check just in case (e.g., Google user already existed)
        ...
        <div>
            ...
            {/* Google Button */}
             <button
               ...
               className={googleButtonStyle} // Use shared style
             >
